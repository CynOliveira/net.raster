...
library(terra)
***
From a binary matrix with columns being "longitude", "latitude" and then all pairs of interacting species or a transposed edgelist of interactions aggregated to sites coordinates (two initial columns).
***
